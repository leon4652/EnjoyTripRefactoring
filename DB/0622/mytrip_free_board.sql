...
CREATE TABLE `free_board` (
  ...
  `board_title` varchar(45) NOT NULL DEFAULT '"제목 없는 게시글"',
  ...
  KEY `fk_board_no_from_user_user_no_idx` (`board_user_no`),
  CONSTRAINT `fk_board_user_no_from_user_user_no` FOREIGN KEY (`board_user_no`) REFERENCES `user` (`user_no`)
